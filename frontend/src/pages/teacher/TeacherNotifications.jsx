// frontend/src/pages/teacher/TeacherNotifications.jsx
  ...
  if (loading) {
    return (
      <div style={styles.container}>
        <Sidebar role="teacher" refreshTrigger={refreshTrigger} />
          ...
          {notifications.length === 0 ? (
            <div style={styles.emptyState}>
              ...
              <div style={{ fontSize: '15px', color: '#94a3b8' }}>
                When students send requests or messages, they'll appear here
              </div>
            </div>
